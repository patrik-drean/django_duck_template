"""
Django settings for pat_app_template project.
...
SECRET_KEY = '-a$$4fg)!j4z%8f8g%z-f!f^)uvo%rl#c7eq+hxkwby62w-=7o'
...
ROOT_URLCONF = 'pat_app_template.urls'
...
WSGI_APPLICATION = 'pat_app_template.wsgi.application'
